import{a as e,i as t,nt as n,ut as r,x as i,z as a}from"./Geometry-BjIcWtQv.js";import{Q as o}from"./RenderTargetSystem-Cm_i15pO.js";import{F as s}from"./GCManagedHash-PCc4nzkl.js";var c={name:`local-uniform-bit`,vertex:{header:`
...
`);return Function(`uv`,`data`,`dataInt32`,`offset`,a)}function y(e,t){return`
    ...
    `}var b={f32:`
        ...
        data[offset + 2] = v[2];
        data[offset + 3] = v[3];
    `},S=class extends r{constructor({buffer:e,offset:t,size:r}){super(),this.uid=n(`buffer`),this._resourceType=`bufferResource`,this._touched=0,this._resourceId=n(`resource`),this._bufferResource=!0,this.destroyed=!1,this.buffer=e,this.offset=t|0,this.size=r,this.buffer.on(`change`,this.onBufferChange,this)}get _gcLastUsed(){return this.buffer?._gcLastUsed??-1}set _gcLastUsed(e){this.buffer&&(this.buffer._gcLastUsed=e)}onBufferChange(){this._resourceId=n(`resource`),this.emit(`change`,this)}destroy(e=!1){this.destroyed=!0,e&&this.buffer.destroy(),this.emit(`change`,this),this.buffer=null,this.removeAllListeners()}};export{_ as a,p as c,c as d,u as f,v as i,d as l,b as n,g as o,l as p,x as r,h as s,S as t,f as u};
//# sourceMappingURL=BufferResource-bpWYw99W.js.map